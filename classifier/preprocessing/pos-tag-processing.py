...
pos_tag_file = open("../data/pos_tag.csv", "a");

# liste des tags qui valident un mot (le mot est retenu lorsqu'il est tagge par au moins un de ces tags)
tags_list = ['JJ', 'JJR', 'JJS'] 
